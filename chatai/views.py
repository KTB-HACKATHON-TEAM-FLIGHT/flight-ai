...
def chat_openai(message):
    ...
    prompt = f"""
            ...
            4. **Formatting**: 
                ...
                - Please set section into padding: 2%; width: 100%; aspect-ratio: 16 / 9; margin-bottom: 2%; and box-sizing: border-box;
                  scroll-snap-align: center center; display: flex; flex-direction: column; justify-content: center; align-items: center; border: 1px solid ligthgray;
                - Please don't set background and text color. 
